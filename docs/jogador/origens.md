...
Os heróis não são definidos apenas por suas classes, mas pelos seus feitos. Embora um herói possa acumular dezenas de títulos ao longo de sua jornada, ele só pode carregar o peso (e os benefícios mecânicos) de **um Título Ativo** por vez.

**A Regra de Ouro do Renome:**
...
Ao criar seu personagem, escolha **um** título baseado na região onde você cresceu. Este será seu título ativo inicial.

| # | Título · *Região* | Talento — Efeito |
| :---- | :---- | :---- |
| **1** | **O Sobrevivente de Khanduras** · *Nova Tristram, a Catedral e as florestas assombradas* | **Nascido nas Sombras** — Vantagem em testes para resistir a Medo ou Loucura. Caso falhe, pode rolar novamente. Se o segundo resultado falhar, deve aceitá-lo. |
| **2** | **O Erudito de Kehjistan** · *Caldeum e os desertos escaldantes do leste* | **Afinidade Elemental** — Ao final de cada descanso longo, escolha um elemento (Fogo, Gelo ou Raio). Você ganha RD 3 a esse elemento até o próximo descanso. |
| **3** | **O Filho de Arreat** · *As estepes geladas e o Monte Arreat* | **Sangue da Montanha** — Você ignora penalidades de movimento por Terreno Difícil Natural (neve, lama, pedras) e ganha \+1d6 em testes de Constituição. |
| **4** | **O Andarilho de Scosglen** · *As florestas druídicas, charcos e chuvas eternas* | **Conhecimento de Ervas** — Sempre que beber uma Poção ou for curado por magia de cura, recupera \+2 HP adicionais. |
| **5** | **O Espião de Entsteig** · *As terras nebulosas das Arqueiras e Ladinos* | **Primeiro a Atirar** — Durante a primeira rodada de qualquer combate, seu deslocamento é dobrado e você ganha \+1 na CA. |
| **6** | **O Duelista de Westmarch** · *A capital militar do oeste, famosa por seus cavaleiros* | **Falange** — Enquanto estiver adjacente a um aliado, você ganha \+2 na AC. |
| **7** | **O Renegado das Terras Pavorosas** · *O norte devastado, lar dos Caçadores de Demônios e sobreviventes do cerco de Baal* | **Instinto de Presa** — Você nunca pode ser surpreendido enquanto estiver descansando e ganha \+2 em testes durante a primeira rodada de combate. Identifica se uma pegada pertence a um demônio ou a um animal comum. |
| **8** | **O Herdeiro de Torajan** · *As selvas profundas do sul, lar dos Feiticeiros e Natispirito* | **Imunidade Tropical** — Você ganha RD 3 a Veneno e Vantagem em testes para resistir a doenças ou infecções. |
| **9** | **O Peregrino de Ivgorod** · *Os monastérios nas montanhas frias, lar dos Monges dos mil e um deuses* | **Equilíbrio Interior** — Você pode gastar ◈ para meditar; até o fim do seu próximo turno, ganha \+1 em todos os testes. |
| **10** | **O Oráculo de Skovos** · *As ilhas tropicais isoladas, território das Amazonas* | **Olho da Tempestade** — Você ignora penalidades de distância em ataques à distância e enxerga o dobro do normal em ambientes de luz fraca. |
| **11** | **O Mercador de Xiansai** · *A ilha exótica ao norte, famosa por seus magos e comércio de gemas* | **Sorte dos Sete** — Uma vez por sessão, transforme uma Falha em Sucesso em qualquer teste. |
...
| :---- | :---- | :---- |
| Arauto da Dor | Causar **20+ de Dano** total em um único ataque. | Seus Acertos Críticos causam **3 dados de Dano** em vez de 2\. |
| O Ceifador | Matar 3 ou mais inimigos em um único turno. | **Impulso de Morte:** Sempre que reduzir um inimigo a 0 PV, você ganha uma **Ação de Movimento** grátis. |
...
| TÍTULO | FEITO (Requisito) | EFEITO ATIVO |
| :---- | :---- | :---- |
| O Imortal | Sobreviver a um golpe restando exatos **1 PV**. | Uma vez por dia, se você cair a 0 PV (**Caído**), você fica com **1 PV** ao invés. |
...
| TÍTULO | FEITO (Requisito) | EFEITO ATIVO |
| :---- | :---- | :---- |
| **Mão do Destino** | Rolar **três** "20 Naturais" na mesma sessão. | Uma vez por sessão, você pode transformar qualquer dado seu em um **20**. |
...
| :---- | :---- | :---- | :---- |
| 1 | **Soldado** | Serviu nas forças militares de algum reino de Santuário | *Disciplina de Combate:* Uma vez por cena, gaste ◇ para ganhar +2 na CA até o início do seu próximo turno. |
...
| 12 | **Renegado** | Serviu forças sombrias antes de se arrepender e partir | *Conhecimento do Inimigo:* Uma vez por cena, revele a fraqueza de um demônio como ◇ — todos os aliados ganham Vantagem em um ataque contra ele. |
