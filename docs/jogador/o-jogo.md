...
* **Foco Mental (2 Mana):** Você pode rolar novamente um Teste de Atributo ou Salvaguarda que tenha falhado.  
* **Escudo de Alma (⟁ \+ X Mana):** Como reação, você gasta Mana para reduzir o dano recebido. Cada 1 ponto de Mana gasto reduz 1 ponto de dano.
...
* Suas ações de Movimento custam **◈◈** em vez de **◈**.  
* Você tem Desvantagem em testes de conjuração ou habilidades físicas complexas.
...
***1d20 \+ Modificador de Atributo (Inteligência, Sabedoria, Carisma)***
...
* Após cada conjuração **bem-sucedida**, a DC para o próximo feitiço aumenta em **\+2**.  
...
| **5** | **Eco do Inferno** | Um lacaio demônio (Fallen) surge de uma fenda no chão e ataca você no próximo turno. |
| **6** | **Pânico Espiritual** | Você fica **Amedrontado** e deve fugir da fonte da magia ou do local da cena por **1d4** rodadas. |

### **Dica Visual: O Dado de Fluxo**

Para tornar isso visual e emocionante na mesa, use o **Dado de Fluxo**:

1. Coloque um **D12** ao lado da sua ficha.  
2. Comece no **0 (DC 10\)**.  
3. **O Mago acertou?** O jogador gira o dado para o **2 (DC 12\)**. *"A realidade está ficando pesada\!"*, você diz.  
