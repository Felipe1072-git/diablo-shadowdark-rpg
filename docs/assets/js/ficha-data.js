...
// Info base de referência para cada armadura (auto-fill no form de item)
const ARMADURA_INFO_BASE = {
  'Couro':           'CA 13 · +Mod DES (Leve)',
  'Couro Reforçado': 'CA 14 · +Mod DES, RD 1 Físico (Leve)',
  'Brunea':          'CA 15 · +Mod DES máx +2, RD 1 (Média, Req. FOR 11)',
  'Cota de Malha':   'CA 16 · +Mod DES máx +2, RD 2 (Média, Req. FOR 11)',
  'Meia-Placa':      'CA 17 · RD 2 (Pesada, Req. FOR 13, Ruído)',
...
const ARSENAL_ARMAS = [
  // Corpo a corpo — 1 mão
  { nome:'Adaga',            infoBase:'1d4 · Leve, Finesse, Arremesso',        duasMaos:false },
  { nome:'Porrete',          infoBase:'1d4 · Leve',                            duasMaos:false },
  { nome:'Foice (Sickle)',   infoBase:'1d4 · Leve, Finesse',                   duasMaos:false },
  { nome:'Katar / Garra',    infoBase:'1d4 · Leve, Finesse, Sangramento',      duasMaos:false },
  { nome:'Martelo Leve',     infoBase:'1d4 · Leve, Arremesso',                 duasMaos:false },
  { nome:'Varinha',          infoBase:'1d4 · Foco Mágico',                     duasMaos:false },
  { nome:'Machado de Mão',   infoBase:'1d6 · Leve, Arremesso',                 duasMaos:false },
  { nome:'Cimitarra',        infoBase:'1d6 · Leve, Finesse',                   duasMaos:false },
  { nome:'Espada Curta',     infoBase:'1d6 · Leve, Finesse',                   duasMaos:false },
  { nome:'Maça',             infoBase:'1d6 · Arremesso',                       duasMaos:false },
  { nome:'Tridente',         infoBase:'1d6 · Versátil (1d8), Arremesso',       duasMaos:false },
  { nome:'Cestus / Punho',   infoBase:'1d6 · Leve, Inapreensível',             duasMaos:false },
  { nome:'Espada Longa',     infoBase:'1d8 · Versátil (1d10)',                 duasMaos:false },
  { nome:'Machado de Guerra',infoBase:'1d8 · Versátil (1d10)',                 duasMaos:false },
  { nome:'Maça Grande',      infoBase:'1d8',                                   duasMaos:false },
  { nome:'Mangual',          infoBase:'1d8 · Imparável',                       duasMaos:false },
  { nome:'Estrela da Manhã', infoBase:'1d8 · Penetrante',                      duasMaos:false },
  { nome:'Martelo de Guerra',infoBase:'1d8 · Versátil (1d10)',                 duasMaos:false },
  { nome:'Rapieira',         infoBase:'1d8 · Finesse',                         duasMaos:false },
  { nome:'Picareta de Guerra',infoBase:'1d8 · Penetrante',                     duasMaos:false },
  // Corpo a corpo — 2 mãos
  { nome:'Cajado',           infoBase:'1d6 · 2H, Foco Mágico, Haste',         duasMaos:true  },
  { nome:'Lança',            infoBase:'1d8 · 2H, Haste, Arremesso',            duasMaos:true  },
  { nome:'Alabarda',         infoBase:'1d10 · 2H, Haste',                      duasMaos:true  },
  { nome:'Glaive',           infoBase:'1d10 · 2H, Haste, Trespassar',          duasMaos:true  },
  { nome:'Pica',             infoBase:'1d10 · 2H, Haste',                      duasMaos:true  },
  { nome:'Foice de Guerra',  infoBase:'1d10 · 2H, Finesse, Trespassar',        duasMaos:true  },
  { nome:'Machado Grande',   infoBase:'2d8 · 2H, Trespassar',                  duasMaos:true  },
  { nome:'Maul (Marreta)',   infoBase:'2d8 · 2H',                              duasMaos:true  },
  { nome:'Lança de Montaria',infoBase:'1d12 · 2H, Haste, Pesada',              duasMaos:true  },
  { nome:'Espada Montante',  infoBase:'2d10 · 2H, Brutal, Pesada',             duasMaos:true  },
  // À distância
  { nome:'Funda',            infoBase:'1d4 · Curto',                           duasMaos:false },
  { nome:'Dardos',           infoBase:'1d4 · Arremesso, Leve',                 duasMaos:false },
  { nome:'Azagaia',          infoBase:'1d6 · Arremesso',                       duasMaos:false },
  { nome:'Faca de Arremesso',infoBase:'1d4 · Leve, Arremesso',                 duasMaos:false },
  { nome:'Arco Curto',       infoBase:'1d6 · Distante, 2H',                    duasMaos:true  },
  { nome:'Arco Longo',       infoBase:'1d8 · Distante, 2H',                    duasMaos:true  },
  { nome:'Besta Leve',       infoBase:'1d8 · Distante, Carga',                 duasMaos:false },
  { nome:'Besta Pesada',     infoBase:'1d10 · Distante, Carga, 2H',            duasMaos:true  },
  // Focos mágicos alternativos
  { nome:'Orbe',             infoBase:'1d4 · Foco Mágico',                     duasMaos:false },
  { nome:'Cristal',          infoBase:'1d4 · Foco Mágico',                     duasMaos:false },
];

// Prefixos canônicos do LdM para datalist + auto-fill de efeito
const PREFIXOS = [
  { nome:'Robusto',      efeito:'+1 CA' },
  { nome:'Forte',        efeito:'+1 CA (+2 contra projéteis)' },
  { nome:'Valente',      efeito:'+2 CA' },
  { nome:'Glorioso',     efeito:'+2 CA (+3 contra projéteis)' },
  { nome:'Santo',        efeito:'+3 CA' },
  { nome:'Divino',       efeito:'+3 CA (+4 contra projéteis)' },
  { nome:'Gemas Básicas',efeito:'+1 RD (tipo à escolha)' },
  { nome:'Gemas Raras',  efeito:'+2 RD (tipo à escolha)' },
  { nome:'Topázio',      efeito:'+2 RD em todos os tipos' },
  { nome:'Prismático',   efeito:'+3 RD em todos os tipos' },
  { nome:'Subjugador',   efeito:'Alvo Surpreso 1 rodada (SAB DC 11 nega)' },
  { nome:'Exaustivo',    efeito:'Alvo Surpreso 1d4 rodadas (SAB DC 15 nega)' },
  { nome:'Esgotante',    efeito:'Iniciativa do alvo → 0 (SAB DC 17 nega)' },
  { nome:'Uivante',      efeito:'Alvo Amedrontado 1 rodada (SAB DC 17 nega)' },
  { nome:'Caótico',      efeito:'Alvo vira aliado por 1d4+1 rodadas (SAB DC 17 nega)' },
  { nome:'Esmagador',    efeito:'Alvo sob Lentidão 2d4 rodadas (SAB DC 19 nega)' },
  { nome:'Matador',      efeito:'+2 Força' },
  { nome:'Apanhador',    efeito:'+2 Destreza' },
  { nome:'Bruto',        efeito:'+2 Constituição' },
  { nome:'Conjurador',   efeito:'+2 Inteligência' },
  { nome:'Monástico',    efeito:'+2 Sabedoria' },
  { nome:'Angelical',    efeito:'+2 Carisma' },
  { nome:'Enferrujado',  efeito:'(Maldição) -1 CA' },
  { nome:'Vulnerável',   efeito:'(Maldição) -2 CA' },
  { nome:'Hiena',        efeito:'(Maldição) Não pode conjurar feitiços' },
  { nome:'Fraco',        efeito:'(Maldição) Todo dano reduzido pela metade' },
  { nome:'Brilhante',    efeito:'Emite luz até Próximo' },
  { nome:'Oracular',     efeito:'Ver criaturas invisíveis' },
  { nome:'Discreto',     efeito:'Invisível para criaturas Distante' },
  { nome:'Sorrateiro',   efeito:'◈: ficar invisível até próxima ação ◈' },
  { nome:'Do Lagarto',   efeito:'+5 Mana Máximo' },
  { nome:'Da Serpente',  efeito:'+10 Mana Máximo' },
  { nome:'Enganador',    efeito:'Ao gastar Mana, 1d10 — em 10 não é consumida' },
  { nome:'Triunfante',   efeito:'Recupera 1 Mana ao desferir golpe fatal' },
  { nome:'Vulpino',      efeito:'⟁ + 1 Mana: RD 3 em todo dano por 1 turno' },
  { nome:'Titânico',     efeito:'+3 em um Atributo à escolha' },
  { nome:'Preciso',      efeito:'+3 nos testes de Ataque' },
  { nome:'Brutal',       efeito:'+3 Dano; crítico expande para 19-20' },
  { nome:'Imparável',    efeito:'+3 Ataque, +3 Dano; crítico expande para 19-20' },
];

// Sufixos canônicos do LdM para datalist + auto-fill de efeito
const SUFIXOS = [
  { nome:'da Saúde',        efeito:'+1 RD em todos os tipos' },
  { nome:'da Proteção',     efeito:'+2 RD em todos os tipos' },
  { nome:'da Absorção',     efeito:'+3 RD em todos os tipos' },
  { nome:'da Vida',         efeito:'+4 RD em todos os tipos' },
  { nome:'da Deflexão',     efeito:'+5 RD em todos os tipos' },
  { nome:'de Espinhos',     efeito:'Ao ser atingido em C.a.C.: atacante sofre 1d4 Físico' },
  { nome:'de Ferrão',       efeito:'Ao ser atingido em C.a.C.: atacante sofre 2d4 Físico' },
  { nome:'do Passo',        efeito:'Corre o dobro com ◈ de movimento' },
  { nome:'da Velocidade',   efeito:'Corre o dobro com ◈ e não pode ser surpreendido' },
  { nome:'da Aceleração',   efeito:'Corre o triplo com ◈ e não pode ser surpreendido' },
  { nome:'do Chacal',       efeito:'+4 HP Temporários' },
  { nome:'da Raposa',       efeito:'+6 HP Temporários' },
  { nome:'do Jaguar',       efeito:'+8 HP Temporários' },
  { nome:'do Lobo',         efeito:'+10 HP Temporários' },
  { nome:'da Águia',        efeito:'+12 HP Temporários' },
  { nome:'do Tigre',        efeito:'+15 HP Temporários' },
  { nome:'do Leão',         efeito:'+18 HP Temporários' },
  { nome:'do Mamute',       efeito:'+20 HP Temporários' },
  { nome:'da Baleia',       efeito:'+25 HP Temporários' },
  { nome:'do Colosso',      efeito:'+30 HP Temporários' },
  { nome:'da Regeneração',  efeito:'Cura 1 PV/turno (acima de 0 PV)' },
  { nome:'da Renovação',    efeito:'Recupera 1 ponto de atributo perdido por turno' },
  { nome:'da Poupança',     efeito:'Usa habilidade sem gastar Mana 1× por dia' },
  { nome:'da Negociação',   efeito:'Usa habilidade sem gastar Mana 2× por dia' },
  { nome:'da Osmose',       efeito:'Usa habilidade sem ações ou Mana 1× por dia' },
  { nome:'da Transcendência',efeito:'Usa habilidade sem ações ou Mana 2× por dia' },
  { nome:'do Gelo',         efeito:'+1d6 Gelo em ataques e feitiços' },
  { nome:'do Fogo',         efeito:'+1d6 Fogo em ataques e feitiços' },
  { nome:'da Eletricidade', efeito:'+1d6 Elétrico em ataques e feitiços' },
  { nome:'do Veneno',       efeito:'+1d6 Veneno em ataques e feitiços' },
  { nome:'da Radiância',    efeito:'+1d6 Radiante em ataques e feitiços' },
  { nome:'da Necromancia',  efeito:'+1d6 Necrótico em ataques e feitiços' },
  { nome:'da Psique',       efeito:'+1d6 Psíquico em ataques e feitiços' },
  { nome:'da Força',        efeito:'+1d6 dano de Força em ataques e feitiços' },
  { nome:'Sede de Sangue',  efeito:'Cura 1d4 PV ao causar crítico ou matar inimigo' },
  { nome:'Rapidez',         efeito:'Reduz custo de ações ou reações em 1 Mana' },
  { nome:'Exorcismo',       efeito:'+1 dado de dano contra Demônios e Mortos-Vivos' },
  { nome:'Laceração',       efeito:'Alvo sangra 1d4 PV/rodada até ser curado' },
  { nome:'Veredito',        efeito:'Impede regeneração e cura mágica do alvo por 3 rodadas' },
  { nome:'Fortuna',         efeito:'+10% chance de encontrar itens raros em saques' },
  { nome:'Precisão',        efeito:'+1d4 em todas as jogadas de ataque com esta arma' },
  { nome:'Sifão de Éter',   efeito:'Ao causar dano, 1d6: em 5-6 recupera 1 Mana' },
  { nome:'Poder Bruto',     efeito:'+5 dano fixo em todos os ataques bem-sucedidos' },
  { nome:'Golpe Mortal',    efeito:'Dano dobrado no 19 natural (além do crítico)' },
  { nome:'Aflição',         efeito:'Alvos atingidos: CON DC 12 ou Cegos por 1 rodada' },
  { nome:'Esmagamento',     efeito:'Reduz CA do alvo em 2 até fim do combate' },
  { nome:'Aniquilação',     efeito:'Ignora bônus de escudo ou armadura natural do inimigo' },
  { nome:'Gelo Eterno',     efeito:'Alvo Imobilizado 1 rodada; imune a efeitos de lentidão' },
  { nome:'Eternidade',      efeito:'Indestrutível + 1 Crítico automático por sessão' },
];
