    ...
    if (resBody) {
      ...
      resBody.innerHTML = Object.entries(resNomes).map(([tipo, nome]) => {
        ...
        return `<tr>
          ...
          <td class="res-extra-cell ${val === 0 ? 'extra-zero' : 'extra-nz'}"><input type="number" class="ficha-input-inline res-extra-input" id="inline-res-${tipo}" value="${val}" min="-20" max="50"></td>
