  ...
  <div>
    ...
    <div class="ficha-panel">
      ...
      <table class="ficha-table" id="res-table">
        <thead><tr><th>Tipo</th><th title="Modificador do atributo base" style="color:#e67e22">⚄ Atrib.</th><th title="RD de itens equipados" style="color:#4a9edd">🛡 Itens</th><th title="Bônus manual">Base</th><th>Total</th></tr></thead>
