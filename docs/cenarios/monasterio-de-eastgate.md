# Monastério de Eastgate — O Banquete de Belial

*O lar nunca existiu. Só existia o tempo que ele precisava que vocês acreditassem nele.*
...
*Use esses detalhes durante a cena do banquete para criar desconforto crescente. Não precisa usar todos — escolha os que couberem na conversa.*

1. Rayna aparece no pátio para receber o grupo pessoalmente. Ela nunca fez isso antes.
2. Ela olha para Harek e diz pelo nome antes de ser apresentada. Se alguém perguntar, ela desconversa: *"A fama de um bom ferreiro viaja rápido."*
...
Quando Rayna sentir que o momento chegou — grupo relaxado, jantar terminando, atenção dispersa — ela pede que todos permaneçam. *"Temos um assunto de segurança a discutir. Preciso de vocês aqui."*

As portas do refeitório são trancadas por fora. Os guardas que ficaram na sala são rostos que ninguém reconhece — nunca foram vistos antes no forte.

---

## O Reveal

Rayna para no meio de uma frase. Levanta a cabeça devagar. Sorri de um jeito que ela nunca sorriu.

A pele do rosto começa a rachar. Uma voz dupla — a dela e outra, mais antiga e mais funda:

> *"Demorou tanto. Eu estava começando a achar que vocês nunca iam voltar. Me diverti muito sendo ela."*

A forma de Rayna se dissolve. Belial está na sala.
...
**Principal:** Sobreviver e derrotar Belial.
...
### TPK — O Contrato de Belial

Se todos os personagens chegarem a 0 PV, Belial não os mata. Ele espera. Quando o último cair, ele se abaixa e sussurra:

> *"Que desperdício seria. Vocês são nephalem — sangue de anjos e demônios. Eu tenho um uso muito melhor para vocês do que um cadáver."*

**Cada jogador escolhe individualmente:**

**A) Servir Belial** — O personagem acorda corrompido. Continua na campanha, mas agora trabalha para Belial. NPCs aliados se tornam inimigos. A narrativa vira um arco de redenção ou traição.

**B) Morte e Avanço de Eras** — O personagem morre. O tempo avança: role na tabela de **Passagem do Tempo** do Registro de Campanha para cada Situação Pendente. O jogador cria um novo personagem em uma nova era. O mundo mudou enquanto Belial não tinha ninguém para detê-lo.

> **Dica:** Os dois grupos (servos e novos heróis) podem coexistir na campanha — o que cria confrontos entre personagens que os jogadores controlavam antes.
