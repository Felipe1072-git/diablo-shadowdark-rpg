# O Carcereiro das Cinzas

*Sua fornalha não consome carne, mas derrete a própria esperança.*  
*Onde ele pisa, o fogo queima frio e branco, forjando correntes de desespero.*

**Augúrios (Omens)**

1. Flocos de cinzas brancas começam a cair do céu como neve, mesmo em um dia abafado. Onde tocam a pele, deixam pequenas queimaduras que ardem como gelo.  
2. O grupo encontra grossas correntes de ferro negro enroladas em troncos de árvores ou pilares de pedra. O metal está vermelho de tão quente, incendiando o ambiente ao redor.  
3. Uma poça de escória incandescente bloqueia o caminho. Ao observar de perto, é possível ver rostos humanos borbulhando na superfície, gritando silenciosamente.  
4. Pegadas pesadas, marcadas por cascos rachados, estão fundidas na rocha sólida do chão. Um calor residual distorce o ar acima delas, dificultando a visão.  
5. O som rítmico e ensurdecedor de um martelo batendo contra uma bigorna gigante ecoa pelas paredes do desfiladeiro (ou masmorra). Cada batida faz o coração dos heróis falhar um compasso.  
6. A terra se parte e uma cratera fumegante se abre. Erguendo-se das profundezas, com asas leomórficas cobrindo a luz e empunhando um braseiro infernal, o Carcereiro exige o tributo de suas almas.
...
#### **A Fornalha Profana (The Profane Furnace)** *Explorar os domínios onde o Carcereiro se estabeleceu é lidar com os extremos térmicos do Inferno. Role 1d6 ao entrar em uma nova área:*
...
| **6** | **Fogo Congelante** | Fogo branco abissal bloqueia uma porta. Atravessá-lo causa 1d6 de dano de *Frio*, congelando a pele e os ossos. |

**A Forja Fria (Espólios do Carcereiro das Cinzas)**  
Quando o Carcereiro é derrotado, sua fornalha interna colapsa, sugando as chamas brancas e deixando para trás uma pilha de escória fumegante e ossos derretidos. Vasculhando os restos, a Comitiva encontra **3d100 x 5 Peças de Ouro (PO)** fundidas umas nas outras (exigindo força para separá-las), **1d4 Topázios Fumegantes** (valendo 80 PO cada) e uma relíquia forjada no desespero. Role 1d6:
...
| **6** | **Runa do Forjador (Cham)** | Pedra rúnica de calor insuportável. Engastada em uma arma, seus ataques ignoram resistências a Fogo e Gelo. Engastada na armadura, não pode ser empurrado ou derrubado. A maldição: a runa pulsa como um farol no submundo. As rolagens de Encontros Aleatórios acontecem com o dobro de frequência nas masmorras. |
