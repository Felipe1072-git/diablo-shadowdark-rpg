...
| **6** | **O Julgamento do Corruptor:** Localizar e derrotar em combate singular um líder inimigo que esteja profanando um local natural. | **Palma Explosiva:** Uma vez por rodada, quando você mata um inimigo, ele explode em luz sagrada, causando 1d10 de dano a todos os inimigos perto. |
...
| **2** | **Purificar a Corrupção:** Limpar uma fonte de água ou solo profanado com orações e rituais. | **Consagração:** O dano de sua arma passa a ser considerado **Radiante** (dobra o dano contra demônios e mortos-vivos). |
