...
### Lista de Classes (Ordem Alfabética)
...
7. Cruzado  
8. Druida  
9. Natispirito (Spiritborn)  
10. Feiticeiro (Witch Doctor)  
11. Guerreiro  
12. Mago (Feiticeiro Elemental)  
13. Monge  
14. Necromante  
15. Paladino  
16. Renegada (Rogue)  
...
### **Guia de Leitura: As Classes de Santuário**

Cada classe neste sistema foi desenhada para representar um arquétipo clássico de Diablo, adaptado para mecânicas de sistemas *d20/Shadowdark*. Ao consultar uma página de classe, observe os seguintes elementos:

* **Dado de Vida (DV):** Define a robustez física da classe. Representa os Pontos de Vida ganhos por nível.  
* **Mana (Recurso):** O valor base de mana, calculado como (10 \+ Modificador de Atributo Primário \+ Nível). É o combustível para habilidades especiais.  
* **Armaduras Permitidas:** Categorizadas pelo peso (Leve, Média, Pesada). Classes com restrição a "Leve" não podem usar armaduras metálicas complexas, priorizando mobilidade.  
* **Armas Permitidas:** Categorizadas pelo peso (Leve, Média, Pesada). Determina quais tipos de armamento o personagem é treinado para utilizar com eficiência.  
...
* **Polivalente:** Você pode usar Destreza no lugar de Força (e vice-versa) em qualquer teste de ataque e dano com armas.  
---
...
| **5** | **Esquiva (Passiva):** Enquanto não usar armadura pesada, ganhe \+1 CA. Se você se mover antes de atacar no mesmo turno, ganhe \+1 CA adicional até o início do seu próximo turno. |
| **6** | **Visão Interior (Passiva):** \+2 em testes de Percepção. Você nunca é surpreendida — mesmo em emboscadas, age normalmente no primeiro turno. |
| **7** | **Golpe Crítico (Passiva):** Seus ataques críticos agora acontecem com 19-20 natural. |
| **8** | **Penetração (⟁ \+ 1 Mana):** Seu próximo ataque reduz a CA do alvo em 3. Ignora também bônus de escudos e coberturas. |
| **9** | **Evasão (⟁ \+ 2 Mana):** Você ignora completamente o dano de uma armadilha ou habilidade de área (explosões, rajadas, magias de cone ou círculo). |
| **10** | **Flecha de Fogo (◈ \+ 1 Mana):** Adicione \+1d6 de dano de Fogo a um ataque de arco. Gaste +1 Mana para cada dado extra. |
| **11** | **Flecha de Gelo (◈ \+ 2 Mana):** Adicione \+1d6 de dano de Gelo a um ataque de arco. O alvo fica **Congelado** por 1 rodada (não pode se mover). Gaste +2 Mana para cada dado extra. |
| **12** | **Flecha Guia (⟁ \+ 2 Mana):** Transforme um erro em um acerto automático (causa dano normal da arma). |
...
| **14** | **Jab (◈ \+ 2 Mana):** Se usar uma arma de haste, faça 3 golpes rápidos em um único alvo. Cada golpe causa 1d6 de dano Físico (sem modificador de atributo). |
...
| **17** | **Isca (◈◈ \+ 1 Mana):** Cria uma cópia ilusória sua. Inimigos devem passar num teste de Sabedoria (DC = 10 \+ Modificador do Atributo Primário) para atacar você em vez da cópia. A cópia dura até ser atingida ou até o fim da cena. |
| **18** | **Esquiva Ativa (⟁ \+ 2 Mana):** Reduza o dano de um ataque recebido em 1d10 \+ Nível. Gaste +2 Mana para cada dado extra. |
| **19** | **Valkíria (◈◈◈ \+ 6 Mana):** Uma vez por cena, invoca uma guerreira etérea por 1d4 rodadas. No seu turno, como ação livre ◇, ela ataca um alvo Próximo. Se atacar o mesmo alvo que você, ambas têm Vantagem. **Valkíria:** CA = sua · HP = Nível × 3 · Dano: 1d8 \+ Mod. Primário Físico |
...
| :---- | :---- | :---- |
| **1** | **O Cume das Deusas:** Escalar o ponto natural mais alto da região e acender uma pira de sinalização. | **Mira Firme:** Você dobra o seu Modificador do Atributo Primário no dano em ataques à distância (Arco ou Javalina). |
...
| **3** | **Santuário Esquecido:** Encontrar um altar oculto de Athulua e purificar a corrupção ao seu redor. | **Primeiro Disparo:** Você ganha \+1d8 de dano adicional no seu primeiro ataque bem-sucedido em cada cena. |
...
| **6** | **Estabelecer Posto Avançado:** Limpar e fortificar uma ruína estratégica, tornando-a um ponto de descanso seguro. | **Golpe de Rechaço:** Sempre que acertar um ataque corpo a corpo, você pode empurrar o alvo para "Próximo". |
...
* **Dínamo Arcano (Passiva):** Sempre que você passar num teste de conjuração, ganhe 1 **Carga Arcana** (máximo: Modificador de INT). Gaste cargas como ◇ para aumentar o dano de feitiços (+2 por carga).  
...
| **6** | **Teleporte (◈ \+ 1 Mana ou ◈ \+ 2 Mana por Aliado):** Como movimento, você pode se teleportar para um lugar "Próximo". Alternativamente, você pode teleportar a você e um aliado "Próximo". |
| **7** | **Lente Arcana (Passiva):** Suas magias têm o dobro de alcance. |
| **8** | **Torrente Arcana (Passiva):** Seus projéteis mágicos causam \+1d4 de dano Arcano extra se você não se moveu neste turno. |
| **9 (1)** | **Distorção Temporal (Feitiço)(◈◈ \+ 4 Mana):** Crie uma zona de lentidão "Próximo" por 1 rodada. Dentro dela: projéteis param no ar, todas as criaturas têm metade do movimento e só podem fazer 1 ◈ por turno. Gaste +4 Mana para cada rodada extra. |
...
| **11** | **Escudo de Diamante (⟁ \+ 3 Mana):** Anule completamente o dano de um único ataque recebido. |
| **12 (3)** | **Desintegrar (Feitiço)(◈ \+ 1 Mana por rodada):** Canalize um raio que causa 1d10 de dano Arcano. A cada rodada que mantiver concentração (◈ \+ 1 Mana), o dano aumenta em \+1d10. Criaturas mortas por esse feitiço viram pó. |
...
| **14 (4)** | **Buraco Negro (Feitiço)(◈◈ \+ 2 Mana):** Puxe todas as criaturas "Próximo" de um ponto para o centro e cause 2d8 de dano Arcano. Gaste +2 Mana para cada dado extra. |
...
| **16 (5)** | **Espada Espectral (Feitiço)(◈◈ \+ 2 Mana):** Uma lâmina espectral varre um arco à frente do Arcanista. Todos os inimigos adjacentes a um ponto "Próximo" sofrem 2d6 de dano Arcano, Fogo, Gelo ou Relâmpago (escolha ao usar). Gaste +2 Mana para cada dado extra. |
...
| **18** | **Fluxo Temporal (◈◈ \+ 5 Mana):** Você e aliados "Próximo" podem usar uma ◈ extra por turno durante 1d4 rodadas. |
| **19 (6)** | **Meteoro (Feitiço)(◈◈◈ \+ 3 Mana):** Marque um local visível. No início do seu próximo turno, um meteoro cai e causa 4d10 de dano Arcano a todas as criaturas "Próximo" do ponto marcado. Gaste +5 Mana para chamar um segundo meteoro (máximo 2). |
| **20** | Escolha qualquer talento desta lista que você ainda não possua. |
...
| :---- | :---- | :---- |
| **1** | **O Tomo Esquecido:** Localizar um livro de magias ou pergaminho antigo em uma biblioteca em ruínas ou covil de culto. | **Ecos do Conhecimento:** Uma vez por descanso longo, você pode conjurar uma magia preparada sem fazer o teste de conjuração. |
...
| **3** | **Selar a Fenda:** Localizar o ponto de origem de uma brecha arcana e usar seu próprio poder para fechá-la. | **Armadura de Energia:** Enquanto não usar armadura, você soma seu Modificador de INT à CA duas vezes (CA = 10 + Mod. INT × 2). Cumulativo com Mente Protegida. |
| **4** | **Geometria Sagrada:** Mapear a disposição de monumentos antigos para descobrir um local de energia oculta, como um altar de Lilith. | **Mente sobre a Matéria:** Sempre que sofrer dano, role 1d10 e reduza o dano recebido por esse valor (⟁, sem custo de Mana). |
...
| **6** | **Comunhão Horadrim:** Encontrar um espírito ou gravação de um antigo mago e aprender uma técnica de manipulação. | **Portal Arcano:** Uma vez por descanso longo, crie um portal instantâneo entre dois locais que você já visitou. O portal dura 1 rodada e é grande o suficiente para uma criatura de tamanho médio passar. |
...
| **5 (1)** | **Punhos de Fogo (◇ Finalizador + 2 Mana):** Seu próximo ataque causa +2d6 de dano de Fogo. |
| **6 (2)** | **Garras de Gelo (◇ Finalizador + 2 Mana):** Seu próximo ataque congela o alvo por 1 rodada. |
| **7 (3)** | **Golpe do Tigre (◇ Finalizador + 3 Mana):** Seu próximo ataque causa dano máximo automático. |
| **8 (4)** | **Chute do Dragão (Finalizador) (◈◈ \+ 1 Mana por chute):** Faça até 3 chutes, cada um arremessando um inimigo Adjacente para Distante. |
| **9** | **Voo do Dragão (Finalizador) (◈◈ \+ 4 Mana):** Teleporte para um inimigo Próximo e faça um chute com Vantagem que causa 3d6 de dano Físico. |
...
| **13** | **Sentinela de Raios (Armadilha) (◈ \+ 1 Mana):** Coloque um marcador na mesa. Uma vez por turno, no início ou no final do seu turno à sua escolha, ela atira um raio no inimigo mais Próximo (dano 1d6 de Relâmpago). Gaste +1 Mana para cada dado extra. |
| **14** | **Sentinela da Morte (Armadilha) (◈ \+ 1 Mana):** Coloque um marcador na mesa. Quando alguém morre Próximo dela, ela explode o cadáver (1d8 dano Necrótico). Gaste +1 Mana para cada dado extra. |
| **15** | **Mestra das Armadilhas (Passiva):** Você pode ter duas armadilhas ativas ao mesmo tempo na mesa. |
| **16** | **Guerreiro das Sombras (◈◈ \+ 2 Mana):** Invoca uma sombra que repete seu último ataque no turno (dura 1d4 rodadas). |
| **17** | **Veneno (◇ \+ 1 Mana):** Suas garras causam 1d4 de dano de Veneno extra por rodada (durante 3 rodadas) após o acerto. |
| **18** | **Explosão Mental (◈◈ \+ 3 Mana):** Você empurra inimigos Próximo apenas com a mente e causa 2d6 de dano Psíquico. Gaste +3 Mana para cada dado extra. |
...
| d6 | Objetivo de Exploração | Recompensa (Dádiva Mecânica) |
| :---- | :---- | :---- |
| **1** | **Infiltração Total:** Alcançar o coração de um acampamento ou fortaleza inimiga sem alertar nenhum vigia. | **Golpe de Misericórdia:** Seu primeiro ataque contra um alvo que ainda não agiu no combate causa \+2d6 de dano extra. |
| **2** | **Desarmar o Caos:** Identificar e desarmar uma armadilha mágica ou mecânica complexa em uma masmorra. | **Mestre das Armadilhas:** Uma vez por turno, você pode gastar uma ação para montar uma armadilha rápida. O próximo inimigo que se mover até você sofre 1d8 de dano e fica imobilizado por **1d4** rodadas. |
| **3** | **Recuperação de Ativos:** Localizar um esconderijo (cache) de armas da ordem Viz-Jaq'taar escondido em terreno hostil. | **Lâminas Velozes:** Ao usar adagas ou armas leves, você ganha um ataque extra com a mão inábil e pode somar seu Modificador de Atributo Primário ao dano deste ataque. |
| **4** | **Caminho das Sombras:** Encontrar uma entrada alternativa ou passagem secreta que evite o confronto principal. | **Capa de Sombras:** Enquanto estiver em luz fraca ou escuridão, os inimigos têm Desvantagem em ataques contra você. |
| **5** | **Silenciar o Conjurador:** Rastrear e observar um usuário de magia corrompido por um dia inteiro e confrontá-lo. | **Voto de Silêncio:** Seus ataques corpo a corpo silenciam o alvo em um acerto crítico (20 natural) — ele não pode conjurar magias até o fim do próximo turno dele. |
| **6** | **Mapeamento de Riscos:** Identificar todas as salas, pontos de saída e emboscada de uma masmorra antes de iniciar o combate final. | **Reflexos de Gatilho:** Você ganha um bônus de \+5 em testes durante a primeira rodada de um combate e nunca pode ser surpreendido em combate. |
...
| **6** | **Pancada (◇ \+ 2 Mana):** Se acertar um ataque, empurre o inimigo para Próximo. O inimigo deve rolar uma Salvaguarda de Constituição ou Força (DC 10 \+ Mod. FOR). Se falhar, cada zona de movimento custa **◈◈** até o início do seu próximo turno. |
| **7** | **Turbilhão (◈ \+ 3 Mana):** Ataque todos os inimigos Adjacentes com uma única rolagem. |
| **8** | **Grito de Guerra (◇ \+ 2 Mana):** O Bárbaro grita e recebe (ou concede a aliados Próximo) \+1d6 de HP Temporário. |
| **9** | **Resistência Natural (Passiva):** Você ganha RD 2 contra Veneno, Fogo, Gelo e Relâmpago. |
...
| **13** | **Frenesi (◇ \+ 1 Mana por Acerto):** Sempre que acertar um ataque, ganha \+1 no próximo ataque (acumulativo até o fim da cena, máx. \+Mod. FOR). |
...
| **15** | **Arremesso de Arma (Passiva):** Você pode arremessar qualquer arma corpo a corpo como se fosse uma arma de arremesso (alcance Próximo). Ao usar armas de arremesso, cause \+1d4 de dano Físico extra. |
...
| **19** | **Chamado dos Antigos (◈◈◈ \+ 4 Mana por Ancestral):** Invoca até 3 espíritos ancestrais até o fim da cena. No seu turno, como ação livre ◇, cada Ancestral ataca um alvo Próximo usando seu mesmo bônus de ataque. **Ancestral:** Dano: 2d6 Físico · Alcance: Próximo. Resolva todos os ataques com uma única rolagem. |
| **20** | Escolha qualquer talento desta lista que você ainda não possua. |
...
| **5** | **Purga de Sangue:** Encontrar um local de massacre e realizar um ritual de fúria (combate extenuante ou esforço físico) para "limpar" a área. | **Fúria Sangrenta:** Quando seus pontos de vida estiverem abaixo da metade, seus ataques causam \+1 dado de dano extra da arma. |
| **6** | **Sentinela do Ermo:** Passar uma noite inteira vigiando o acampamento em pé, sem dormir, enquanto o resto do grupo descansa em segurança. | **Instinto de Batalha:** Você ganha \+2 em testes durante o primeiro turno de cada combate e seu valor de CA aumenta em \+1 para cada 2 inimigos que estiverem te cercando. |
...
* **Flecha Faminta (Ódio) (◈◈ \+ 2 Mana)**: Dispara uma flecha magicamente imbuída que causa dano normal da arma e atravessa todos os inimigos em linha até Próximo.  
...
| **7** | **Granada (Ódio) (◈◈ \+ 2 Mana):** Arremessa uma granada em um ponto Próximo que explode e causa 2d6 de dano de Fogo em inimigos Adjacentes ao ponto de impacto. Gaste +2 Mana para cada dado extra. |
| **8** | **Cortina de Fumaça (Disciplina) (◈ \+ 1 Mana):** Invisível por 1 rodada ou até atacar. |
| **9** | **Sentinela (Ódio) (◈ \+ 1 Mana):** Coloque um sentinela. Quando um inimigo entrar em Próximo dela, ela dispara automaticamente causando 1d6 de dano Físico (uso único). Gaste +1 Mana para cada dado extra. |
...
| **11** | **Companheiro Animal (Ódio) (◈ \+ 3 Mana):** Invoca um companheiro animal. **Companheiro:** CA 13 · HP = Nível×2 (mínimo 5) · Dano: 1d6 Físico · ATK: mesmo bônus do Caçador. Age no seu turno com ◈. Dura até zerar o HP. |
| **12** | **Poder das Sombras (Disciplina) (◈◈ \+ 2 Mana):** Por 3 rodadas, recupera 1 HP sempre que causar dano.  |
| **13** | **Armadilha de Estacas (Disciplina) (◈◈ \+ 3 Mana):** Cria uma armadilha embaixo do alvo. Ele faz uma Salvaguarda de DES (DC 10 \+ Mod. DES). Se falhar, sofre 2d6 de dano Físico e fica imobilizado até o início do seu próximo turno. Gaste +3 Mana para cada dado extra. |
| **14** | **Tiro Rápido (Ódio) (◈ \+ 2 Mana):** Mova-se e faça dois ataques à distância.  |
| **15** | **Fã de Facas (Ódio) (◈◈ \+ 2 Mana):** Causa 2d6 Físico em área Próximo. Inimigos atingidos fazem Salvaguarda de DES (DC 10 \+ Mod. DES) ou têm o movimento reduzido pela metade até o início do seu próximo turno. Gaste +2 Mana para cada dado extra. |
...
| **19** | **Chuva de Vingança (◈◈◈ \+ 5 Mana):** Dezenas de flechas caem do céu em uma área Próximo. Todos os inimigos na área sofrem 3d6 de dano Físico por rodada durante 1d4 rodadas. Gaste +5 Mana para cada dado extra. |
| **20** | Escolha qualquer talento desta lista que você ainda não possua. |
...
| **4** | **Infiltrado nas Sombras:** Atravessar uma zona ocupada por inimigos sem ser visto e sem disparar um único tiro. | **Conhecimento:** Uma vez por descanso longo. Ao sofrer dano fatal, o Caçador de Demônios não morre, mas fica invisível por 1 rodada e recupera 50% do seu HP máximo. |
...
| **6** | **Ponto de Vigília:** Estabelecer um refúgio seguro em uma zona hostil que permita ao grupo realizar um descanso longo sem interrupções. | **Preparação:** Sempre que realizar um descanso, você e seu grupo recebem Vantagem em testes durante a próxima cena que participarem. |
...
* **Mestre da Lança:** Você tem \+1 para atacar com armas de haste. Além disso, você pode gastar uma ◈ para fazer um ataque extra com a ponta inversa desse tipo de arma (dano base 1d4 Físico).   
...
| **5** | **Gume Sombrio (Feitiço) (◈ \+ 1 Mana):** Lança uma adaga de sangue em um inimigo Próximo, causando 1d6 de dano Necrótico. Gaste +1 Mana para cada adaga extra. |
...
| **7** | **Lança Empaladora (◈ \+ 3 Mana):** Se acertar um ataque, você pode prender o inimigo no chão. Inimigo faz um Teste de Força **DC = 10 + Modificador do Atributo Primário** para escapar. |
| **8** | **Sanguinar (◈◈ \+ 2 Mana):** Avance em linha reta até Próximo e cause 1d6 Necrótico automático a todos no caminho. Gaste +2 Mana para cada dado extra. Você não gera ataques de oportunidade. |
| **9** | **Sentidos Sobrenaturais (Passiva):** Você pode enxergar perfeitamente no escuro total (mesmo sem tochas) em alcance Curto. |
| **10** | **Drenar Sangue (Feitiço) (◈ \+ 1 Mana):** Drene 1d4 de HP de um inimigo Próximo e recupere a mesma quantidade de HP. |
| **11** | **Esmagar o Fraco (◇ \+ 1 Mana):** Você causa \+1d4 necrótico contra inimigos que não estejam com o HP cheio. |
| **12** | **Sudário da Noite (Feitiço) (◈ \+ 5 Mana):** Envolva a si mesmo e aliados Próximo em trevas até o início do seu próximo turno. **Aparições sombrias** de cada criatura afetada surgem em seus turnos para **desferir um Ataque Extra** uma vez por rodada como ação livre **◇**.  |
...
| **18** | **Onda de Sangue (Feitiço) (◈◈ \+ 2 Mana):** Uma explosão circular. Todos os inimigos Adjacentes sofrem 2d6 Necrótico e são empurrados para Próximo. Gaste +2 Mana para cada dado extra. |
| **19** | **Abominação (Transformação) (◈◈◈ \+ 10 Mana):** Torne-se um monstro por 3 rodadas. Com uma ação de ataque **◈** Você **ataca 2x com garras (2d10 necrótico \+ Mod. Primário)**. Com ação livre **◇,** **ganha \+5 HP temporários no início de cada rodada**. Você pode se transformar sem o custo de mana, mas deve fazer um teste de **SAB DC 20 \- Level Atual** ou sucumbir à maldição e se tornar uma abominação descontrolada para sempre. |
| **20** | Escolha qualquer talento desta lista que você ainda não possua. |
...
| **4** | **Comunhão das Sombras:** Encontrar um local de escuridão absoluta e permanecer lá por horas, domando a fera interior sem ceder à loucura. | **Passo de Sangue:** Uma vez por rodada, você pode se transformar em uma névoa de sangue e se teletransportar para um espaço vazio Próximo que você possa ver. |
...
* **Magia Divina:** Caso aprenda feitiços, você usa a **Sabedoria** para conjurá-los.  
---
...
| **6** | **Escudo Reluzente (Feitiço) (◈◈ \+ 3 Mana):** Inimigos Próximo ficam cegos por 1 rodada (Desvantagem nos ataques). |
| **7** | **Punição (⟁ \+ 2 Mana):** Quando um inimigo errar um ataque contra você, realize um ataque imediato com Vantagem que causa \+1d6 de dano Radiante. |
...
| **19** | **Campeão de Akarat (◈◈◈ \+ 10 Mana):** Cresça em tamanho e poder. Ganhe um bônus extra igual ao **Modificador do Atributo Primário** em todos os ataques e danos. Você também regenera **1d10 HP** no início do turno por 1d4 rodadas. |
| **20** | Escolha qualquer talento desta lista que você ainda não possua. |
...
| **5** | **O Sermão de Ferro:** Inspirar uma milícia local ou vila a se levantar contra um opressor através de um feito de força. | **Líder da Vanguarda:** Aliados Próximo ganham \+1 na CA e não sofrem penalidades de moral. |
...
| d6 | Objetivo de Exploração | Recompensa (Dádiva Mecânica) |
| :---- | :---- | :---- |
| **1** | **O Bosque de Cinzas:** Localizar um bosque ou área florestal totalmente destruída e realizar o ritual do "Desperto Verde" para que a vida retorne. | **Golpe Terremoto:** Uma vez por rodada, seu ataque corpo a corpo causa \+2d6 de dano e derruba o alvo. |
...
| **10** | **Olho da Águia (◈ \+ 1 Mana):** Faça ataques à distância (lanças/glaives) que ignoram cobertura. |
| **11** | **Frenesi de Fogo (Jaguar) (◈ \+ 1 Mana):** Ganhe uma ação extra **◈** por rodada durante 1d4 rodadas. |
| **12** | **Nuvem de Esporos (Centopeia) (◈◈ \+ 4 Mana):** Inimigos Próximo devem fazer uma Salvaguarda de CON (DC 10 \+ Mod. SAB) ou ficam atordoados por 1 rodada. |
...
| **15** | **Torvelinho de Penas (Águia) (◈ \+ 1 Mana):** Dispare um projétil de vento que causa 1d6 de dano Físico em área Próximo ao acertar o alvo. Gaste +1 Mana para cada projétil extra. |
...
| **4** | **Limpar a Podridão:** Localizar uma área consumida por uma praga antinatural e usar venenos rituais para acelerar o ciclo de morte e renascimento. | **Veneno Potente:** O alvo sofre 1d6 de dano Veneno no início de cada turno dele por 3 rodadas. (Acumulativo) |
...
| **6** | **Selo do Véu:** Fechar uma fenda espiritual por onde criaturas do além estão vazando para o nosso mundo sem autorização. | **Passo do Espírito:** Como parte do seu movimento, você pode se tornar incorpóreo até o fim do seu turno, permitindo passar por paredes de até 1m de espessura e por espaços ocupados por inimigos. |
...
* **Cães Zumbis:** Você começa o jogo com **dois** Cães Zumbis. Use ◈ para agir com todos durante seu turno (Mover, Atacar). Usam o Atributo Primário nos testes. Se morrerem, gaste ◈ + 1 Mana por Cão para trazê-los de volta. **Cão Zumbi:** CA 12 · HP = Nível (mínimo 1) · Dano: 1d4 Físico · ATK: mesmo bônus do Feiticeiro  
...
| **6 (2)** | **Nuvem de Gafanhotos (Feitiço) (◈ \+ 2 Mana):** Uma nuvem de pragas que saltam de inimigo em inimigo, causando 1d6 de dano Físico automático em todos os inimigos Próximo. Gaste +2 Mana para cada dado extra. Dura 1d4 Rodadas. |
...
| **9 (5)** | **Invasão de Sapos (Feitiço) (◈ \+ 1 Mana):** Uma horda de sapos explosivos cobre o chão causando 1d6 de dano Veneno. Gaste +1 Mana para cada dado extra. A área é de terreno difícil e dura 1d4 Rodadas. |
| **10** | **Sacrifício (◈ \+ 1 Mana por Cão):** Você explode seus Cães Zumbis. Cada cão causa 1d8 de dano Necrótico a criaturas Adjacentes. |
| **11** | **Gargântua (◈ \+ 5 Mana):** No lugar de um dos Cães, invoca 1 Gargântua. **Gargântua:** CA 15 · HP = Nível×3 (mínimo 10) · Dano: 2d8 Físico · ATK: mesmo bônus do Feiticeiro. Dura até zerar o HP. |
...
| **14 (8)** | **Piranhas (Feitiço) (◈◈ \+ 2 Mana):** Cria uma poça de água que causa 2d8 de dano Veneno durante 1d4 rodadas. Gaste +2 Mana para cada dado extra. Quem estiver na área sofre um dano extra de 1d4 de todas as fontes (ataques, feitiços, etc). |
| **15** | **Exército de Fetiche (◈◈◈ \+ 1 Mana):** Invoca um pigmeu com adaga para lutar ao seu lado. Gaste +1 Mana para cada pigmeu extra. Duram 1 cena. **Pigmeu:** CA 13 · HP = Nível (mínimo 1) · Dano: 1d4 Físico · ATK: mesmo bônus do Feiticeiro |
...
| **17 (10)** | **Parede de Zumbis (Feitiço) (◈◈ \+ 2 Mana):** Cria uma barreira física de corpos na mesa por 1d4 rodadas. Inimigos Próximo da parede sofrem 1d8 de dano Físico. Gaste +2 Mana para cada dado extra. **Extra:** Pode gastar \+1 Mana para mudar o tipo de dano para Fogo, Gelo ou Veneno. |
| **18 (11)** | **Colheita de Almas (Feitiço) (◈ \+ 2 Mana por Inimigo):** Drene a inteligência de até 5 inimigos Próximo. Ganhe \+2 para conjurar, por inimigo, durante 3 rodadas. |
| **19 (12)** | **Assombração (Feitiço) (◈◈◈ \+ 5 Mana):** Um espírito persegue um alvo, causando 2d8 de dano Necrótico no início de cada turno do alvo. Gaste +5 Mana para cada dado extra. Se o alvo morrer, o espírito salta para o inimigo mais Próximo. O espírito dura 1d4+1 rodadas no total. |
| **20** | Escolha qualquer talento desta lista que você ainda não possua. |
...
| d6 | Objetivo de Exploração | Recompensa (Dádiva Mecânica) |
| :---- | :---- | :---- |
| **1** | **A Colheita de Ervas Proibidas:** Localizar e coletar 3 ingredientes raros em áreas de perigo extremo (pântanos tóxicos, covis de bestas). | **Nuvem de Ácido:** Uma vez por cena, seu próximo ataque de área ignora qualquer resistência a dano dos inimigos e causa **\+1d8** de dano Veneno. |
...
| **3** | **Comunhão com o Ancião:** Localizar o espírito de um antigo pajé em uma ruína e realizar um ritual para ouvir seus segredos. | **Visão de Além-Véu:** Você consegue detectar portas secretas, armadilhas e criaturas invisíveis Próximo, mesmo na escuridão total. |
...
| **6** | **Desafio da Força Bruta:** Erguer um portão de ferro, segurar um teto desabando ou remover um obstáculo massivo para permitir a passagem do grupo. | **Impacto Avassalador:** Se você fizer apenas um ataque no seu turno, dobre o bônus de atributo (Força) ao dano. |
...
* **Afinidade Elemental:** No nível 1, escolha um elemento (Fogo, Gelo ou Relâmpago). Você tem **Vantagem** para conjurar feitiços desse elemento.  
...
| **7 (1)** | **Armadura de Gelo (Feitiço) (◈ \+ 1 Mana por rodada):** Você conjura uma armadura de gelo por 1 rodada, inimigos que te acertarem corpo a corpo sofrem 1d8 de dano Gelo e ficam congelados por 1d4 rodadas. |
| **8** | **Saque de Mana (Passiva):** Se matar um inimigo com magia, ganha \+2 no próximo teste de conjuração. |
| **9 (2)** | **Nova de Gelo (Feitiço) (◈ \+ 2 Mana):** Uma explosão circular que causa 1d10 de dano Gelo a todos Próximo por 1d4 rodadas. Gaste +2 Mana para cada dado extra. Criaturas que ficarem com HP 0 são congeladas indefinidamente (O mago decide se estão mortas ou não). |
| **10 (3)** | **Bola de Fogo (Feitiço) (◈ \+ 2 Mana):** Uma explosão que causa 1d8 de Fogo em área Próximo. Gaste +2 Mana para cada dado extra. Deixa os alvos queimando (1d4 de Fogo/turno por 1d4 rodadas ou até o alvo usar ◈ para apagar). |
| **11 (4)** | **Seta Elétrica (Feitiço) (◈ \+ 2 Mana):** Dispare 3 faíscas que causam 1d4+1 de dano Relâmpago cada em alvos diferentes. Gaste +2 Mana por seta extra. |
...
| **13 (6)** | **Nevasca (Feitiço) (◈ \+ 2 Mana):** Cria uma zona Próximo onde inimigos sofrem 1d6 de dano Gelo e movem metade por 1d4 rodadas. Gaste +2 Mana para cada dado extra. |
| **14 (7)** | **Cadeia de Raios (Feitiço) (◈ \+ 2 Mana):** Um raio que pula em até 3 inimigos Próximo, causando 1d10 de dano Relâmpago em cada. Gaste +2 Mana para cada dado extra. |
| **15 (8)** | **Hidra (Feitiço) (◈ \+ 2 Mana):** Invoca 1d4 cabeças de fogo que disparam bolas de fogo em inimigos Próximo. Uma vez por turno, no início ou final do seu turno à sua escolha, cada cabeça causa 1d6 de Fogo. Duram 1d4 rodadas. Gaste +2 Mana para cada dado extra. Só é possível ter um conjunto de hidras ativo por vez. |
...
| **17 (9)** | **Parede de Fogo (Feitiço) (◈◈ \+ 4 Mana):** Cria uma parede de fogo de tamanho Próximo. Dura 1d4 rodadas. Qualquer criatura que a atravessar sofre 3d6 de dano Fogo. Gaste +4 Mana para cada dado extra. |
| **18 (10)** | **Orbe Congelada (Feitiço) (◈ \+ 3 Mana):** Lance uma esfera que viaja em linha reta até Próximo, disparando 1d6 de Gelo em todas as criaturas Adjacentes no caminho. A esfera explode ao final do trajeto causando 3d6 de Gelo. Gaste +3 Mana para cada dado extra na explosão. |
...
| d6 | Objetivo de Exploração | Recompensa (Dádiva Mecânica) |
| :---- | :---- | :---- |
| **1** | **O Coração da Chama:** Localizar uma fonte de calor extremo (vulcão, incêndio eterno ou forja mística) e meditar em suas bordas. | **Combustão Espontânea:** Se o seu feitiço de fogo atingir apenas um alvo, ele sofre **1d10** de dano Fogo no início do próximo turno dele e permanece por **1d4** rodadas. |
| **2** | **O Pico Glacial:** Escalar o cume mais frio da região e sobreviver a uma noite inteira sem usar fogo para se aquecer. | **Casca de Gelo:** Sua CA aumenta em \+2 permanentemente. Além disso, atacantes corpo a corpo que te atingirem têm seu deslocamento reduzido à metade na rodada seguinte. |
| **3** | **O Para-raios Arcano:** Permanecer no ponto mais alto de uma tempestade elétrica e "atrair" a energia para um cristal ou foco. | **Descarga Elétrica:** Se você matar um inimigo com um feitiço de Relâmpago, a energia salta para inimigos Adjacentes, causando metade do dano original. |
...
| **16** | **Santuário Interior (◈ \+ 4 Mana):** Cria um círculo na mesa por 1d4 rodadas. Inimigos não podem entrar e aliados dentro dele ganham Vantagem em todos os testes. |
...
| **18** | **Experiência de Quase Morte (⟁ \+ 5 Mana):** Ao ficar com HP 0, o Monge não morre, mas é curado em metade do HP máximo e tem sua Mana restaurada para metade (a menos que já possua mais). |
| **19** | **Aliado Místico (◈◈◈ \+ 5 Mana):** Invoca uma cópia espiritual que luta ao seu lado por 1d4 rodadas. **Aliado:** CA = sua · HP = seu HP máximo. No seu turno, como ação livre ◇, ela repete o último ataque que você usou. |
| **20** | Escolha qualquer talento desta lista que você ainda não possua. |
...
| **3** | **Protetor do Caminho:** Escoltar um grupo de refugiados ou um indivíduo indefeso através de uma zona de perigo sem que eles sofram dano. | **Defesa Contrária:** Sempre que um inimigo errar um ataque corpo a corpo contra você, ele sofre dano imediato igual ao seu bônus de Sabedoria. |
...
| **6** | **O Julgamento do Corruptor:** Localizar e derrotar em combate singular um líder inimigo que esteja profanando um local natural. | **Palma Explosiva:** Uma vez por rodada, quando você mata um inimigo, ele explode em luz sagrada, causando 1d10 de dano a todos os inimigos Próximo. |
...
* **O Comandante da Horda:** Você controla até **Mod. Primário + Nível** esqueletos. Use ◈ para agir com todos durante seu turno (Mover, Atacar). Usam o Atributo Primário nos testes. Duram até zerar o HP. **Esqueleto:** CA 12 · HP = Nível · Dano: 1d4 Físico · ATK: mesmo bônus do Necromante  
* **Levantar Mortos (Feitiço) (◈ \+ 1 Mana):** Como uma ação, role o **Atributo Primário** (DC 15 − Nível) para erguer esqueletos de cadáveres Próximo. Se passar, você ergue 1d4 esqueletos de uma vez (até o seu limite).  
* **Feitiço Básico:** Role 1d8 para definir seu feitiço inicial.  
---
...
| **6 (2)** | **Lança de Osso (Feitiço) (◈ \+ 2 Mana):** Um projétil que atravessa inimigos em linha reta até Próximo. Dano 2d8 Físico. Gaste +2 Mana para cada dado extra. |
...
| **10** | **Golem de Argila (◈ \+ 3 Mana):** Em vez de 3 esqueletos, invoca 1 Golem. **Golem:** CA 15 · HP = Nível×3 (mínimo 10) · Dano: 1d8 Físico · ATK: mesmo bônus do Necromante. Dura até zerar o HP. |
...
| **14 (5)** | **Parede de Ossos (Feitiço) (◈ \+ 2 Mana):** Cria uma barreira de ossos na mesa que bloqueia o movimento por 1d4 rodadas. A Barreira tem CA 16 e 10 HP. Gaste +1 Mana para cada 10 HP extras. |
...
| **18** | **Mago Esqueleto (◈ \+ 2 Mana):** Em vez de 2 Esqueletos, invoca 1 Esqueleto Mago. **Esqueleto Mago:** CA 12 · HP = Nível · Dano: 1d8 Fogo, Gelo, Relâmpago ou Necrótico · Alcance: Próximo · ATK: mesmo bônus do Necromante. Dura até zerar o HP. |
...
| **3** | **Ossário do Herói:** Localizar os restos mortais de um antigo guerreiro em uma masmorra e recuperar um fragmento de sua ossada. | **Ossificação:** Sua CA natural aumenta em \+1 permanentemente e você ganha Redução de Dano (RD) 2 contra ataques Físicos. |
...
| d20 | Talento |
| :---- | :---- |
| **1-2** | \+2 de Força ou \+2 de Carisma. |
| **3-4** | \+1 em ataques corpo a corpo ou \+1 em testes de conjuração. |
| **5** | **Vigor (Aura)(◈):** Você e aliados Próximo podem se mover o dobro da distância. |
...
| **8** | **Carga (◈◈ \+ 1 Mana):** Avance em linha reta para Distante e ataque. Se acertar, o alvo cai (caído). |
| **9** | **Setas Sagradas (Feitiço) (◈◈ \+ 2 Mana):** Dispare um raio de luz. Cura 1d6 em aliado ou causa 1d8 de dano Radiante em morto-vivo/demônio. Gaste +2 Mana para cada dado extra. |
| **10** | **Escudo Sagrado (Feitiço) (◈ \+ 3 Mana):** Seu escudo brilha, dando \+3 na CA por uma cena. |
| **11** | **Meditação (Aura)(◈):** Aliados na aura têm Vantagem para recuperar feitiços durante descansos curtos. |
| **12** | **Punho dos Céus (Feitiço) (◈◈ \+ 4 Mana):** Um raio cai do céu. Dano 2d10 Radiante em um alvo e solta Setas Sagradas (1d10 Radiante) em inimigos Próximo. Gaste +4 Mana para cada dado extra. |
...
| **14** | **Salvação (Aura)(◈):** Você e aliados na aura ganham RD 2 a um tipo de dano Elemental (Fogo/Gelo/Relâmpago). |
...
| d6 | Objetivo | Recompensa (Dádiva de Disciplina) |
| :---- | :---- | :---- |
| **1** | **Converter um Cético:** Convencer alguém que perdeu a fé a realizar um ato de caridade ou coragem. | **Selo de Esperança:** Uma vez por cena, você e um aliado ganham Vantagem em um teste. |
| **2** | **Purificar a Corrupção:** Limpar uma fonte de água ou solo profanado com orações e rituais. | **Vingança:** O dano de sua arma passa a ser considerado **Radiante** (dobra o dano contra demônios e mortos-vivos). |
...
| d6 | Objetivo de Exploração | Recompensa (Dádiva Mecânica) |
| :---- | :---- | :---- |
| **1** | **O Olho do Batedor:** Mapear todos os pontos de entrada, saída e rotas de patrulha de uma fortaleza ou masmorra. | **Golpe de Abertura:** Seu primeiro ataque bem-sucedido em um combate causa **\+2d6** de dano adicional. |
| **2** | **A Mão Invisível:** Roubar um item vital (chave, mapa ou relíquia) de uma sala guardada sem disparar um único alarme. | **Lâminas Gêmeas:** Ao usar adagas ou armas leves, você pode fazer um ataque extra, mas sem somar bônus de atributo ao dano desse segundo ataque. |
...
* **Ligação Demoníaca:** Você pode conjurar demônios para lutar ao seu lado. Um de cada tipo. Use ◈ para agir com todos durante seu turno (Mover, Atacar). Duram até zerar o HP.  
  * **Sumonar Homem Cabra (◈ \+ 1 Mana):** **Homem Cabra:** CA 13 · HP = Nível×2 (mínimo 5) · Dano: 1d6 Físico · ATK: mesmo bônus do Warlock. Pode **Empurrar** com ◈.  
...
| **6 (1)** | **Marca da Morte (Feitiço) (◈ \+ 1 Mana por demônio):** Teleporta seus demônios para um inimigo Próximo e os permite fazer um ataque. |
| **7 (2)** | **Sumonar Corrompido (Feitiço) (◈ \+ 3 Mana):** Conjura um demônio reptiliano. **Corrompido:** CA 15 · HP = Nível×3 (mínimo 10) · Dano: 2d6 Fogo · ATK: mesmo bônus do Warlock · RD 5 Fogo. Dura até zerar o HP. |
| **8 (3)** | **Sumonar Profanador (Feitiço) (◈ \+ 3 Mana por inimigo):** Conjura um demônio de carne flutuante. **Profanador:** CA 15 · HP = Nível×3 (mínimo 10) · ATK: mesmo bônus do Warlock. Enquanto estiver vivo, vincula o HP dos inimigos alvo — todos sofrem o mesmo dano que qualquer um deles receber. |
...
| **14 (9)** | **Apocalipse (Feitiço) (◈◈ \+ 2 Mana):** Cria um pentagrama Próximo que engolfa inimigos em sua área com 2d6 de Fogo e remove resistência a Fogo caso o inimigo tenha. Gaste +2 Mana para cada dado extra. |
...
| **19** | **Forma Demoníaca (◈◈◈ \+ 8 Mana):** Você se transforma em um demônio por 1d4 rodadas. Ganha \+5 de Força e 20 HP temporários. Com uma ação **◈** faz 2 ataques de garra (2d6 Fogo \+ Mod. Primário) ou 1 ataque laser (3d6 Fogo, alcance Longo). |
| **20** | Escolha qualquer talento desta lista que você ainda não possua. |
